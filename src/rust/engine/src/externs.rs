...
pub fn store_u32(val: u32) -> Value {
  with_externs(|e| (e.store_u32)(e.context, val).into())
}
...
pub type StoreU32Extern = extern "C" fn(*const ExternContext, u32) -> Handle;
